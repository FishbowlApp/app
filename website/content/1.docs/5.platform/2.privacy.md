...
description: Privacy policy for the Fishbowl platform
...
This Privacy Policy applies to the Fishbowl app (the "app") for mobile devices, which was created
by the Fishbowl team (the "service provider" or "we/us") as a free service.
...
When you use the app, it attempts to make a connection to the closest Fishbowl server to provide you with the best
...
If you'd like the Fishbowl team to delete all data that you have provided via the app, please contact us at [help@attiplayz.dev](mailto:help@attiplayz.dev)
...
Only the lead developer of the Fishbowl team has direct access to the databases utilized by the app. All other
...
via email at [help@attiplayz.dev](mailto:help@attiplayz.dev) or on our official Discord community. We're happy to help in any way we can.
