...
description: Contributing to the Fishbowl project
navigation.icon: i-material-symbols-terminal-rounded
---

# Contributing to Fishbowl

We welcome all kinds of contributions to the Fishbowl project. Whether you're a developer, designer, or writer, there's
a place for you in our community. This guide will help you get started with contributing to the project.

## GitHub

All facets of the Fishbowl project are hosted on GitHub under the [FishbowlApp](https://github.com/FishbowlApp)
...
The Fishbowl project is divided into several repositories, each with its own purpose. Here are some of the main
repositories you might be interested in:

- [FishbowlApp/fishbowl](https://github.com/FishbowlApp/fishbowl): The source code for the Fishbowl API backend and Discord
bot. Built with Elixir, Phoenix, and ScyllaDB.
- [FishbowlApp/app](https://github.com/FishbowlApp/app): The source code for the Fishbowl mobile app. Built with Kotlin
...
[Discord support server](https://discord.neocon.attiplayz.dev)
...
If you're a developer, you can contribute to the Fishbowl project by writing code. Fishbowl is a polyglot project, written
...
We deploy our services using Docker containers on a mix of a cloud VPS and some local hardware. Should donations come through, the plan is to upgrade the dedicated hardware.
