...
description: Security features provided by the Fishbowl app
navigation.icon: i-material-symbols-security-rounded
---

# Security features

The Fishbowl app is designed with security and safety in mind, and provides several features to ensure that the data
on your device is not exposed to anyone else.

## PIN lock

The Fishbowl app allows you to set up a PIN lock to prevent unauthorized access to your account. This is located
...
You may access the "real" app by tapping the Fishbowl **logo** in the top-left of the screen **twice** in a row. You
