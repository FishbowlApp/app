...
description: Getting started with the Fishbowl Discord bot
navigation.icon: i-logos-discord-icon?mask
---

# Getting started

Fishbowl provides a Discord bot that acts as a companion to the Fishbowl app, providing additional features such as
alter proxying (similar to Tupperbox or PluralKit) in addition to providing a slash-command interface for the app's
base features.

## Adding the bot to your server

To add the Fishbowl bot to your server, you can use
[this invite link](https://discord.com/api/oauth2/authorize?client_id=1482225774328152136&permissions=9090969500736&scope=bot%20applications.commands).
...
- **Link an existing account**: If you previously registered an account using the Fishbowl app, you can link that account to
your Discord account by TODO.

## Using the bot

All interactions with the Fishbowl bot are done through
...
This is just a small taste of what the Fishbowl bot can do! For a full list of commands and their usage, see our
