...
description: Learn how to proxy messages as alters with the Fishbowl Discord bot
navigation.icon: i-material-symbols-chat-rounded
---

# Proxying messages

The primary feature of the Fishbowl Discord bot is the ability to "proxy" chat messages as your alters. This allows you to
