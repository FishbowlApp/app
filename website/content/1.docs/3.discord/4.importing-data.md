...
description: Import data from PluralKit or Simply Plural into the Fishbowl bot
...
**Note**: If you have any issues with the import process from either platform, please reach out to the `#bot-support` channel
...
Once you have the token, paste it into the `token` field of the command and execute it. The bot will then import all
your members, groups, front history, and custom fields from Simply Plural into Fishbowl. It may take a few minutes for
all of your data to be imported, especially if you have a large number of alters in Simply Plural.
...
The bot will then import all your members and groups from PluralKit into Fishbowl. It may take a few minutes for all
